    ...
    <>
      ...
      <div className="about-section-2 container">
        ...
        <div className="image-2">
          <img src="\IMG_20240425_085350.jpg" />
        </div>
      </div>
        ...
        <div className="container">
          ...
          <div className="content-3">
            <div className="content-container">
              <img src="\IMG_20240425_100125.png" />
            </div>
        ...
        <div className="about-4-items">
          <div className="items-con">
            <div className="circle-4">
              <img src="/uploads/admprcore-pic-1.png" />
            </div>
          ...
          <div className="items-con">
            <div className="circle-4">
              <img src="/uploads/admprcore-pic-3.png" />
            </div>
            <div className="circle-conta">
          ...
          <div className="items-con">
            <div className="circle-4">
              <img src="/uploads/admprcore-pic-2.png" />
            </div>
            <div className="circle-conta">
          ...
          <div className="items-con">
            <div className="circle-4">
              <img src="/uploads/core-pic-4.png" />
            </div>
            <div className="circle-conta">
          ...
          <div className="commit-con">
            <div className="commit-item">
              <div>
                <div className="commit-sub">
                  <img src="/assets/img/about/vission.png" />
                  <h2>Our Vision</h2>
                </div>
                <p>
            ...
            <div className="commit-item">
              <div>
                {" "}
                <div className="commit-sub">
                  <img src="/assets/img/about/mission.png" />
                  <h2>Our Goal</h2>
                </div>{" "}
                <p>
