  ...
  <>
    ...
    <div className='trust'>
      <div><FcGoogle size={50} /></div>
        ...
        <div className='trust'>
            <div><img alt='image' src='/uploads/r-icon2.png'/></div>
            <div><div>Published in</div><div className='trust-text'>5000+ Channels</div></div>
            


        </div>
        <div className='trust'> <div><img alt='image' src='/uploads/r-icon3.png'/></div>
            <div><div>1000+</div><div className='trust-text'>Happy Clients</div></div>
            </div>
        <div className='trust'> <div><img alt='image' src='/uploads/r-icon4.png'/></div>
