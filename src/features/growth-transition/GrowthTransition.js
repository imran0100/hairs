...
<div className='growth-container container'>
    <div>
        <img alt='image' src='/uploads/icon1.png'/>
        <a><span>01</span> HAIR LOSS/THINING </a>
    </div>
    <div>
        <a><span>02</span>HAIR TEST</a>
        <img alt='image' src='/uploads/icon2.png'/>
    </div>
    <div>
        <img alt='image' src='/uploads/icon3.png'/>
        <a><span>03</span>EVOLUTION OF PHOTOS</a>
    </div>
    <div>
        <a><span>04</span>CONSULTATION</a>
        <img alt='image' src='/uploads/icon4.png'/>
    </div>
    <div>
        <img alt='image' src='/uploads/icon5.png'/>
        <a><span>05</span>TREATMENT PLAN</a>
    </div>
    <div>
        <a><span>06</span>HAIR GROWTH</a>
        <img alt='image' src='/uploads/icon6.png'/>
    </div>
</div>
