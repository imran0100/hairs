...
function ShoppingFeature() {
  return (
    <div className='shopping-feature container'>
        <div>
            <img alt='hair' src='/uploads/shipping-icon1.png'/>
            <div>
        ...
        <div>
            <img alt='hair' src='/uploads/shipping-icon2.png'/>
            <div>
        ...
        <div>
            <img alt='hair' src='/uploads/shipping-icon3.png'/>
            <div>
        ...
        <div>
            <img alt='hair' src='/uploads/shipping-icon4.png'/>
            <div>
