    ...
    <Navbar>
      ...
      <div className='container'>
        <div className='product-section'>
          <div className='product-image'><img alt='hair' src={product?.thumbnail} alt={product?.title} /></div>
      ...
      <div className='container'>
        <img alt='hair' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFaQLv4xMAdfKo3N6F-5QgGB3sv0hkxxkGJRtdSB6DyA&s'/>
      </div>
      <Product/>
      <ShoppingFeature/>
      <Footer/>
