    ...
    <>
      ...
      <div className="specialist-section-2 container">
        <div className="section-item">
          <img src="/uploads/admprsp-icon1.png" />
      ...
      <div className="specialist-section-4 container">
        ...
        <div className="section-4-second">
          ...
          <img src="/assets/img/specialists/award.png" />
        </div>
      </div>
      <div className=' container'>
        ...
        <div className="doc-container">
            {doctors.map((item)=>
            <div className="doctors"><div className="doc-image"><img src={item.src}/></div>
      ...
      <div className="councellor-container ">
        ...
        <div className="councellor-item">
          <div className="coun-item">
            <img src="/uploads/admprcoun-icon1.png"/>
            <p>Education & Confidence Boosting</p>
          </div>
       
          <div className="coun-item">
            <img src="/uploads/coun-icon2.png"/>
            <p>Resut Assessment</p>
          </div>
          <div className="coun-item">
            <img src="/uploads/coun-icon3.png"/>
            <p>Recommedation & Product Knowledge</p>
          </div>
          <div className="coun-item">
            <img src="/uploads/coun-icon4.png"/>
            <p>Hair Health and Style Guiding</p>
          </div>
          <div className="coun-item">
            <img src="/uploads/coun-icon5.png"/>
