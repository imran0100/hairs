              ...
              <div className='hero-container container'>
                <div className='hero-content'>
                 ...
                 <div className='Edit-Image'> <input type="file" accept="image/*" />
                  <img alt='hair' className='hero-image' src='/uploads/admprhero-banner.png' alt='Hair Growth' /></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className='wrapper'>
              <div className='hero-container container'>
                <div className='hero-content'>
                  ...
                  <div className='Edit-Image'> <input type="file" accept="image/*" />
                  <img alt='hair' className='hero-image' src='/uploads/admprhero-banner-two.png' alt='Hair Growth' /></div>
